...
(function () {
  ...
  // --- create a form and add eventListener to 'submit button' ---
  var mainElement = document.getElementsByTagName('main').item(0);

  var newForm = document.createElement('form');  // ❤ create a <form> and add attribute to it

  console.group('Form Creation');
  var numericalInput = document.createElement('input');  // ❤ create a number <input> and add attribute to it
  ...
  var submitButton = document.createElement('input');  // ❤ create a submit <input>
